...
function Navbar() {
  return (
    <nav className="fixed bottom-0 w-full bg-gray-800 text-white flex 
          justify-around py-3 md:max-w-md md:mx-auto md:rounded-t-lg">
      {/* <div className="flex justify-around py-3 md:max-w-md md:mx-auto md:rounded-t-lg"> */}
        <NavLink 
          to="/" 
          className={({ isActive }) => `flex flex-col items-center text-sm ${
